...
```
### 📅 TODO / Next Steps ###
* Local Cache: Add BigCache to reduce Redis load.
* Distributed Tracing: Use Jaeger to see the whole path from API to Worker.
* Dynamic Rate Limiter: Auto adjust rate limit based on CPU usage.
